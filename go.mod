module github.com/leobuzhi/wukong
...
require (
	...
	github.com/leobuzhi/murmur v0.0.0-20130808212358-e0489551cf51
	github.com/leobuzhi/sego v0.0.0-20180617034105-3f3c8a8cfacc
